...
// MedicalRecordsAPI interface definition
...
// NewMedicalRecordsAPI constructor
func NewMedicalRecordsAPI() MedicalRecordsAPI {
	return &implMedicalRecordsAPI{}
}

// addRoutes implementation
func (api *implMedicalRecordsAPI) addRoutes(routerGroup *gin.RouterGroup) {
	routerGroup.POST("/medical_records", api.CreateMedicalRecord)
	routerGroup.GET("/medical_records", api.GetAllMedicalRecords)
	routerGroup.GET("/medical_records/:recordId", api.GetMedicalRecordById)
	routerGroup.PUT("/medical_records/:recordId", api.UpdateMedicalRecord)
	routerGroup.DELETE("/medical_records/:recordId", api.DeleteMedicalRecord)
}

// CreateMedicalRecord implementation
func (api *implMedicalRecordsAPI) CreateMedicalRecord(ctx *gin.Context) {
...
// GetAllMedicalRecords implementation
func (api *implMedicalRecordsAPI) GetAllMedicalRecords(ctx *gin.Context) {
	value, exists := ctx.Get("medical_record_db_service")
	if !exists {
		ctx.JSON(http.StatusInternalServerError, gin.H{
			"status":  "Internal Server Error",
...
// GetMedicalRecordById implementation
func (api *implMedicalRecordsAPI) GetMedicalRecordById(ctx *gin.Context) {
	value, exists := ctx.Get("medical_record_db_service")
	if !exists {
		ctx.JSON(http.StatusInternalServerError, gin.H{
			"status":  "Internal Server Error",
...
// UpdateMedicalRecord implementation
func (api *implMedicalRecordsAPI) UpdateMedicalRecord(ctx *gin.Context) {
	value, exists := ctx.Get("medical_record_db_service")
	if !exists {
		ctx.JSON(http.StatusInternalServerError, gin.H{
			"status":  "Internal Server Error",
...
// DeleteMedicalRecord implementation
func (api *implMedicalRecordsAPI) DeleteMedicalRecord(ctx *gin.Context) {
	value, exists := ctx.Get("medical_record_db_service")
	if !exists {
		ctx.JSON(http.StatusInternalServerError, gin.H{
			"status":  "Internal Server Error",
